...
class _OtpTextFieldState extends State<OtpTextField> {
      ...
      child: TextField(
        ...
        onChanged: (String value) {
          if(value.length == 2){
            ...
            _textControllers[index]?.selection = TextSelection.fromPosition(const TextPosition(offset: 1));
          }
  ...
  void onCodeChanged({required List<String?> verificationCode}) {
    if (widget.onCodeChanged != null) {
      widget.onCodeChanged!(verificationCode.join());
    }
  }
}
