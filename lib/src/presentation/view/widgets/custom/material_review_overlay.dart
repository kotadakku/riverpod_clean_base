...
import 'material_barcode_sensing_painter.dart';

class MaterialPreviewOverlayCustom extends StatefulWidget {
  const MaterialPreviewOverlayCustom(
  ...
  @override
  MaterialPreviewOverlayCustomState createState() => MaterialPreviewOverlayCustomState();
}

class MaterialPreviewOverlayCustomState extends State<MaterialPreviewOverlayCustom>
